...
from .pandas.text_encoder import TextEncoder
...
class PandasDataPreprocessor(DataPreprocessor):
    ...
    def __init__(self,
                 ...
                 cols_category_with_mapping: dict = None,           # added by xqy
                #  cols_text: List[str] = None,                     # added by xqy
        ...
        if cols_first_item is None:
            cols_first_item = []
        if cols_category_with_mapping is None:
            cols_category_with_mapping = {}
        ...
        for col in cols_category:
            ...
            elif col in cols_category_with_mapping:
                # Use predefined mapping for this column
                cts_category.append(PredefinedCategoryEncoder(
                    col_name_original=col,
                    predefined_mapping=cols_category_with_mapping[col]
                ))
        ...
        #added by xqy
        # cts_text = [TextEncoder(col_name_original=col) for col in cols_text]
        ...
        super().__init__(
            ...
            # cts_text=cts_text,     #added by xqy
        )
